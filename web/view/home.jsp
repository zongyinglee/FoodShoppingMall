...
<div id="home_banner" class="HomeBannerView">
    ...
    <div class="HomeBannerViewTopNav">
        <ul>
            ...
            <li class="fl"><a href="/home/view">食品购物网站</a></li>
...
<div id="home_base" class="HomeBase">
    <%--顶部导航栏--%>
    <div class="HomeBaseNav" id="home_base_nav" style="background-color:#ffc363">
        <ul>
            <li class="fl"><img src="../image/零食.png"></li>
            <li class="fl"><a>食品购物网站</a></li>
            <li class="fl">
                <input id="home_base_nav_key" type="text" placeholder="请输入食品关键词">
            </li>
            <li class="fl">
    ...
    <div class="HomeLoginBg" id="home_sign_up">
        ...
        <div class="cf" style="margin-bottom: 50px;"></div>
        <input type="text" id="home_sign_up_name" placeholder="邮箱" class="form-control">
    ...
    <div class="HomeBaseBottom">
        © 2020 食品购物网站. All rights reserved.
    </div>
</div>
<%--确认订单对话框--%>
